...
import { ifewFanGuideContent, ifewGuideImage } from "@/components/ifew-fan-guide/content";
...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description, url, type: "website", locale: locale === "en" ? "en_US" : "ko_KR", images: [{ url: ifewGuideImage, alt: content.imageAlt }] },
  };
}
