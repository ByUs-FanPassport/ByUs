...
export type HomeContentErrors = { homeBanners?: boolean; celebrities?: boolean; celebrityLives?: boolean; featuredLives?: boolean };
...
function GuestHomeContent({ homeBanners = [], celebrities, celebrityLives = [], featuredLives, locale, contentErrors = {}, initialOwnedOnly, initialRole = "all" }: GuestHomeProps) {
  const t = copy[locale];
  const router = useRouter();
      ...
      <div className={styles.shell}>
        <main id="main-content" className={styles.main}>
          <section className={styles.heroSection} aria-labelledby="live-heading">
            ...
            <LiveHeroCarousel elina={celebrities.find(celebrity => celebrity.slug === "elina")} homeBanners={homeBanners} locale={locale} />
          </section>
