...
const available: PublicOnchainResult = {
  ...
  snapshot: {
    ...
    historicalActions: 0,
    actions: [
      { actionId: "0xaction", occurrenceId: "0xoccurrence", revision: 0, actionCode: 10, wallet: "0x29b000d7791c671a9556a0c83b985b7487364082", creatorId: "creator", campaignId: "campaign", occurredDay: 20709, easUid: "0xeas", txHash: "0xtx", blockNumber: "35954999", status: "ACTIVE", current: true, qa: true, origin: "NATIVE", credentials: [] },
      { actionId: "0xexpired", occurrenceId: "0xexpired-occurrence", revision: 0, actionCode: 9, wallet: "0x0000000000000000000000000000000000000001", creatorId: "", campaignId: "", occurredDay: 20708, easUid: "0xexpired-eas", txHash: "0xexpired-tx", blockNumber: "35954998", status: "ACTIVE", current: false, qa: false, origin: "NATIVE", credentials: [] },
    ],
    transactions: [
      { txHash: "0xtx", blockNumber: "35954999", kind: "record", qa: true, origin: "NATIVE" },
      { txHash: "0xcorrect", blockNumber: "35955000", kind: "correct", qa: true, origin: "NATIVE" },
      { txHash: "0xinvalidate", blockNumber: "35955001", kind: "invalidate", qa: true, origin: "NATIVE" },
    ],
  },
};
