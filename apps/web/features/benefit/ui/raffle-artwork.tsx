...
export function RaffleArtwork({ raffle, large = false, compact = false }: { raffle: RaffleList["raffles"][number]; large?: boolean; compact?: boolean }) {
  ...
  return <div className={`${styles.artwork} ${compact ? styles.compactArtwork : ""} ${large ? styles.largeArtwork : ""} ${beepio ? styles.beepioArtwork : ""} ${statue ? styles.statueArtwork : ""}`}>
