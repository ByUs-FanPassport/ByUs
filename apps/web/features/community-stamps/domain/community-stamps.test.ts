...
describe("community stamp projection", () => {
 ...
 it("keeps unverified external awards unavailable", () => {expect(AVAILABLE_COMMUNITY_STAMPS).not.toContain("subscription");expect(AVAILABLE_COMMUNITY_STAMPS).not.toContain("support");expect(AVAILABLE_COMMUNITY_STAMPS).not.toContain("share");});
});
