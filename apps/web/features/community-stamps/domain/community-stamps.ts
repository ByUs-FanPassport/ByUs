...
export const COMMUNITY_STAMPS = {
  ...
  share: { asset: "share", ko: "공유하기", en: "Share", scope: "creator", koHelp: "최애 패스포트를 SNS에 공유해요.", enHelp: "Share your favorite’s Passport on social media." },
...
export const AVAILABLE_COMMUNITY_STAMPS: readonly CommunityStampKind[] = ["welcome", "first_comment", "daily_checkin", "invite"];
