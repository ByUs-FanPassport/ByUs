...
describe("news ordering",()=>{
 it("prioritizes a pinned announcement over a welcome guide while limiting home to three",()=>{
  const notices=[{slug:"welcome",title:"안내",pinned:true,kind:"welcome" as const,publishedAt:"2026-09-15"},{slug:"important",title:"공지",pinned:true,kind:"standard" as const,publishedAt:"2026-09-01"}];
