...
function mapped(error:unknown){
  ...
  const status=code.endsWith("NOT_FOUND")?404:code.includes("REQUIRED")?403:code.includes("INVALID")?422:code.includes("ALREADY")||code.includes("CONFLICT")||code.includes("WALLET")?409:503;
