...
export function createG6AnalyticsRouteDependencies() {
  ...
  return {authorize,platformRepository:createPlatformAnalyticsRepository({url:environment.SUPABASE_URL,serviceRoleKey:environment.SUPABASE_SERVICE_ROLE_KEY})};
}
