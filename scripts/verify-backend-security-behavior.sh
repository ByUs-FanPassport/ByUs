...
psql -X -v ON_ERROR_STOP=1 -f "$root_dir/supabase/tests/community_stamp_share_behavior.sql"
BYUS_COMMUNITY_STAMP_CONCURRENCY_MODE=1 bash "$root_dir/scripts/verify-community-stamp-concurrency.sh"
BYUS_COMMUNITY_STAMP_SHARE_RACE_MODE=1 bash "$root_dir/scripts/verify-community-stamp-share-concurrency.sh"
