...
insert into public.celebrities(id, slug, image_url, image_position, roles,primary_role) values
  ('71000000-0000-4000-8000-000000000011', 'fan-stage-alpha', 'https://example.test/alpha.jpg', 'center', '{artist}','idol'),
  ('71000000-0000-4000-8000-000000000012', 'fan-stage-beta', 'https://example.test/beta.jpg', 'center', '{artist}','idol');
