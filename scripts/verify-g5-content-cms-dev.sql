...
begin
  ...
  insert into public.celebrities(id,slug,image_url,roles,primary_role) values
    (celebrity_a,'cms-proof-a','/proof-a.jpg','{artist}','idol'),(celebrity_b,'cms-proof-b','/proof-b.jpg','{artist}','idol');
