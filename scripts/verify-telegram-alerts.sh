...
enqueue()
claims=race("select public.claim_telegram_alert_batch('-100123')", "select public.claim_telegram_alert_batch('-100123')")
...
enqueue()
token=json.loads(sql("select public.claim_telegram_alert_batch('-100123')"))['batch_id']
...
assert sql("select public.claim_telegram_alert_batch('-100456')")==''
