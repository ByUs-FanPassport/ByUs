-- Accept checksum/lowercase equivalence while reconciling an exact completed legacy Passport job.
-- This replaces the submit function forward-only after the first Dev reconciliation exposed address casing drift.
