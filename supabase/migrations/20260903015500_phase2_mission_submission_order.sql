-- Mission answers must be written while their response is still draft. The existing
-- immutability trigger correctly rejects inserts after a response is submitted.
