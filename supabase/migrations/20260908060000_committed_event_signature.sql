-- Committed fan activity events use the versioned RPC smallint signature.
-- A bare integer literal resolved to no function and silently skipped every event.
create or replace function public.project_committed_product_event_v1()
...
begin
  ...
  begin
    perform public.record_product_event_v1(1::smallint,v_event,v_owner,null,v_celebrity,v_live,v_mission,v_benefit,
